...
const skills = [
  { category: "Frontend", items: ["React", "TypeScript", "Framer", "Tailwind CSS"] },
  { category: "Backend", items: ["Supabase", "Node.js", "REST APIs"] },
  { category: "Tools", items: ["Cursor AI", "n8n", "WordPress", "Elementor"] },
  { category: "Design", items: ["UI/UX", "Framer Motion", "Responsive Design"] },
];
          ...
          >
            <div className="relative aspect-[3/4] max-w-md mx-auto lg:mx-0">
              ...
              <div className="relative z-10 w-full h-full rounded-2xl overflow-hidden border border-border">
                <img
                  src={kiraPortrait}
                  alt="Kirubel Daniel - Full Stack Developer"
