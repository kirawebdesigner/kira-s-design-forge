...
const projects = [
  ...
  },
  {
    ...
    description: "A halal dating mobile app helping Muslims find meaningful connections while honoring their values. Includes landing page & app design.",
    image: projectLanding,
    tags: ["Mobile App", "UI/UX", "Landing Page"],
