...
const projectsData = {
  ...
  "landing": {
    ...
    challenge: "Creating a dating app that respects Islamic values while providing a modern, engaging user experience. The app needed to balance cultural sensitivity with contemporary design trends and intuitive matchmaking features.",
    solution: "Developed a beautifully designed landing page and mobile app with features like halal matchmaking, user verification, and a family-friendly approach. The design emphasizes trust, privacy, and meaningful connections.",
    process: [
      { step: "Research & Strategy", description: "Understood the target audience's needs and cultural requirements for a Muslim dating platform." },
      { step: "UI/UX Design", description: "Created a warm, inviting design with pink/red accents that feels modern yet respectful." },
      { step: "Landing Page Development", description: "Built a high-converting landing page showcasing app features and testimonials." },
      { step: "Mobile App Integration", description: "Ensured seamless user experience across iOS and Android platforms." },
    ],
    results: [
      "Professional, culturally-sensitive design",
